...
<div class="shell">
  <div class="border">
    ...
    <div id="main">
      <div id="content" class="left">
        <div class="highlight">
          <h3>О себе</h3>
          <img src="css/images/143.jpg" alt="" class="right" />
          <p id="glav">Я, Исакова Марина Валентиновна являюсь учителем русского языка с 1997 года, за свой стаж я выпустила 25 классов с основным общим образованием. Имею высшее педагогическое образование.</p>
        </div>
        <div class="projects">
    ...
    <!-- Еще блоки -->
    <?php
        $articles = mysqli_query($connection, "SELECT * FROM `novosti` ORDER BY `id` DESC LIMIT 6");
  ...
  <div id="footer">
    ...
    <p class="right"><a href="cmsland.php?mode=30">Для учителя</30
    <div class="cl"></div>
  </div>
</div>
